        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            contentItems.push((0, _redom.el)("dl.ccm__tabgroup" + "." + key + ((_window$CookieKonsent = window.CookieKonsent.config.categories[key]) !== null && _window$CookieKonsent !== void 0 && _window$CookieKonsent.checked ? ".checked-5jhk" : ""), {
              "data-category": key
            }, (0, _redom.el)("dt.ccm__tab-head", _Language.default.getTranslation(window.CookieKonsent.config.categories[key], window.CookieKonsent.config.language.current, "name"), !window.CookieKonsent.config.categories[key].needed && (0, _redom.el)("div.ccm__switch-component", (0, _redom.el)("div.ccm__switch-group", (0, _redom.el)("label.ccm__switch", (0, _redom.el)("input.category-onoff", {
              type: "checkbox",
              "data-category": key,
